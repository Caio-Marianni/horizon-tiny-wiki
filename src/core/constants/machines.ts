...
const machines: Machine[] = [
  {
    id: 1,
    nome: "Thunderjaw",
    icon: "/machines/Thunderjaw-Icon.webp",
    imagem: "/machines/Thunderjaw.webp",
    ...
    weakness: ["/elements/Fire.webp", "/elements/Freeze.webp", "/elements/Plasma.webp"],
    resistance: ["/elements/Acid.webp", "/elements/Shock.webp", "/elements/Purgewater.webp"],
    ...
    id: 4,
    nome: "Tideripper",
    icon: "/machines/Tideripper-Icon.webp",
    imagem: "/machines/Tideripper.webp",
    weakness: ["/elements/Freeze", "/elements/Shock.webp"],
    resistance: ["/elements/Fire.webp", "/elements/Purgwater.webp"],
